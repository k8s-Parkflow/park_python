...
class InternalProjectionViewContractTests(TestCase):
    def test_should_return_current_parking__when_projection_exists(self) -> None:
        with patch(
            "parking_query_service.parking_view.interfaces.http.views.get_current_parking",
            return_value={
    ...
    def test_should_project_entry__when_payload_valid(self) -> None:
        with patch(
            "parking_query_service.parking_view.interfaces.http.views.project_entry",
    ...
    def test_should_revert_entry__when_payload_valid(self) -> None:
        with patch(
            "parking_query_service.parking_view.interfaces.http.views.revert_entry",
    ...
    def test_should_project_exit__when_payload_valid(self) -> None:
        with patch(
            "parking_query_service.parking_view.interfaces.http.views.project_exit",
            return_value={"projected": True},
        ):
            response = self.client.post(
    ...
    def test_should_restore_exit__when_payload_valid(self) -> None:
        with patch(
            "parking_query_service.parking_view.interfaces.http.views.restore_exit",
