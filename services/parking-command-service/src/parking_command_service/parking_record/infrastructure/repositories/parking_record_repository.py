...
from parking_command_service.parking_record.domain import ParkingHistory
from parking_command_service.parking_record.domain import ParkingSlot
from parking_command_service.parking_record.domain import SlotOccupancy
